            ...
            <div class="admin-middle-left-content-box">
                <form action="UpdateCategoryServlet" name="addcat" method="post">
                    <table>
                        ...
                        <tr>
                            <td>Category: &nbsp;</td>
                            <td><input class="textfield" type="text" name="catname" value="<% if (catID != null) {
                                    out.print(editcat.getName());
                                } %>"/></td>
                        </tr>
                        <tr>
                            <td>Mô tả: &nbsp;</td>
                            <td><input class="textfield" type="textarea" name="catdescribes" rows="5" cols="20" value="<% if (catID != null)
                                    out.print(editcat.getDescribes()); %>"/></td>
                        </tr>
                        <tr>
                            <%
                                if (catID != null) {
