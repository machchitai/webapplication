...
<%
    ...
    if (bSource != null) {
        session.setAttribute("bSource", bSource);
    }
            ...
            <div class="admin-middle-left-content-box">
                <form action="UpdateBalanceSourceServlet" name="updateBalanceSource" method="post">
                    <table>
                        ...
                        <tr>
                            <td>Giá trị: &nbsp;</td>
                            <td><input required="true" class="textfield" type="text" name="price" value="<% if (bSource != null) {
                                    out.print(editbalance.getPrice());
                                } %>"/>&nbsp;,000 VNĐ</td>
                        </tr>
                        <tr>
                            <td>Mô tả: &nbsp;</td>
                            <td><input class="textfield" type="textarea" name="describes" rows="5" cols="20" value="<% if (bSource != null) {
                                    out.print(editbalance.getDescribes());
                                } %>"/></td>
                        </tr>
                        <tr>
                            <td>Sử dụng: &nbsp;</td>
                            <td>
                                <select required="true" name="available" class="textfield">
                                    <option value="0" <% if (bSource != null && editbalance.getAvailable() == 0) {
                                            out.print("selected");
                                        } %> >0</option>
                                    <option value="1" <% if (bSource != null && editbalance.getAvailable() == 1)
