...
<%
    ...
    if (newID != null) {
        session.setAttribute("newsid", newID);
    }
            ...
            <div class="admin-middle-left-content-box">
                <form action="UpdateNewsServlet" name="addNews" method="post">
                    <table>
                        ...
                        <tr>
                            <td>Title: &nbsp;</td>
                            <td><input class="textfield" type="text" name="newsTitle" value="<% if (newID != null) {
                                    out.print(editnew.getTitle());
                                } %>"/></td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                <textarea class="textview" name="newsContent" placeholder="Nhập nội dung bài viết ở đây"><% if (newID != null) {
                                        out.print(editnew.getContent());
                                    } %></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td>publicDate: &nbsp;</td>
                            <td><input id="datepicker" class="textfield" type="text" name="newsDate" value="<% if (newID != null)
                                    out.print(editnew.getCreateddate()); %>"/></td>
                        </tr>
